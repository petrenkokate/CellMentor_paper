...
SIM_NUMBER = '_newcelltype_exclude4_final'
set.seed(100)
...
seu_ref <- subset(seu_ref, Group %in% c('Group1', 'Group2', 'Group3',
                                        # 'Group4',
                                        'Group5',
                                        'Group6'))
...
file_path <- paste0('save_data_v2/simulation_method', SIM_NUMBER, '_group_merge.qs')
